    ...
    <>
      <Modal show={show} onHide={handleClose} className="modal">
        ...
        <Modal.Body>
            ...
            <Row>
              <Col xs={1}>
                <img
                  ...
                  alt="user-img"
                  className={classNames(styles.user_image, "mx-1")}
                />
              </Col>
              <Col>
                <span className={styles.user_name}>Sagar</span>
              </Col>
            </Row>
          </div>
          <div className="mt-2 ">
          ...
          <span className={classNames(styles.createpost_emoji, "text-muted")}>
          ...
          <Row>
            <Col xs={9}>
              <div className="d-flex text-muted">
                <i
                  className={classNames("fa-solid fa-image", styles.post_icon)}
                ></i>
                <i
