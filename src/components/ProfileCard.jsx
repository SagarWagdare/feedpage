  ...
  return (
    <Col md={1}>
      ...
      >
        ...
        <div>
          <h5 className={styles.userProfile_userName}>Sagar Wagdare</h5>
          <span className={styles.userProfile_detail}>FrontEnd Developer</span>
        </div>
        <hr />
        <div className="mx-4">
          <p>Connections</p>
