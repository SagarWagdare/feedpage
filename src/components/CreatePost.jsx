    ...
    <>
      <Modal show={show} onHide={handleClose} className="modal">
        <Modal.Header closeButton>
          <Modal.Title>
            <span className="text-center fs-5">Create Post</span>{" "}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div>
            <Row>
              <Col xs={1}>
                <img
                  ...
                  alt="user-img"
                  className="user_image mx-1"
                />
              </Col>
              <Col>
                <span className="user_name">Sagar</span>
              </Col>
            </Row>
          </div>
          <div className="mt-2 ">
          ...
          <span className="text-muted createPost_emoji">
          ...
          <Row>
            <Col xs={9}>
              <div className="d-flex text-muted">
                <i className="fa-solid fa-image post_icon"></i>
                <i className="fa-brands fa-youtube post_icon"></i>
                <i className="fa-regular fa-file post_icon"></i>
                <i className="fa-solid fa-ellipsis post_icon"></i>
              </div>
            </Col>
            <Col>
              <Button className="border-0 " variant="secondary" disabled>
                Post
              </Button>
            </Col>
          </Row>
