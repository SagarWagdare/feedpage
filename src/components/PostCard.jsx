  ...
  return (
    <Col>
      <div className="container">
        <Card
          // className="create_post shadow mt-2"
          className={classNames(styles.create_post, "shadow", "mt-2")}
        >
          <Row className="p-2">
            <Col xs={1}>
              <img
        ...
        {PostData.map((data) => (
          <Card
            key={data.id}
            className={classNames("shadow", styles.feedCard, "my-2")}
          >
            <Row>
              <Col xs={1}>
                <img
                  src={data.userImg}
                  alt="user-img"
                  className={classNames(styles.user_image, "mt-2")}
                />
              </Col>
              <Col className="mt-2">
